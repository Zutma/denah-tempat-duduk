        ...
        <form method="POST" action="{{ route('study-programs.store') }}" class="flex flex-col gap-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="degree_level" name="degree_level" value="{{ old('degree_level') }}" placeholder="Contoh: S1"
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Masukkan Nama Program Studi"
