...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-bold text-gray-800">Edit Program Studi</h1>
    ...
    <div class="p-6 rounded-xl shadow-sm border border-gray-200 bg-white">
        <form method="POST" action="{{ route('study-programs.update', $studyProgram) }}" class="flex flex-col gap-4">
            @csrf
            @method('PUT')
